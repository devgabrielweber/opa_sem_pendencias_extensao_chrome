...
function executarScript() {
    ...
    intervaloVerificar = setInterval(() => {
        ...
        try {
            ...
            elem = iframeDoc.querySelectorAll('[class="text-gray-1000 md:text-xl text-lg text-left font-bold truncate"]')
            elem3 = iframeDoc.querySelectorAll('[class="flex w-full items-center p-8 justify-start bg-background-secondary rounded-xl border border-gray-400 cursor-pointer"]')
        } catch (error) {
            elem[1] = null
            elem3[1] = null
        }
